...
export const cappedButtonClass =
  'flex-1 rounded border border-warn bg-warn/10 py-2 px-3 text-sm font-semibold text-warn hover:bg-warn/20 disabled:opacity-60'
    ...
    <div className="space-y-2 rounded border border-warn/45 bg-warn/10 p-3">
      ...
      <div className="flex gap-2">
        <button
          type="button"
          onClick={onContinue}
          className="rounded bg-warn px-3 py-1.5 text-xs font-semibold text-ink hover:brightness-110"
        >
          Continue Anyway
        </button>
        {onEditDirectly && (
          <button
            ...
            className="rounded border border-warn bg-raised px-3 py-1.5 text-xs font-semibold text-warn hover:bg-warn/20"
          >
